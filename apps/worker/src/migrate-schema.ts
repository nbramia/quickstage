...
export async function migrateAllUsersToNewSchema(env: any): Promise<void> {
...
export async function migrateAllSnapshotsToNewSchema(env: any): Promise<void> {
...
export function migrateUserToNewSchema(user: any): UserRecord {
  const now = Date.now();
...
export function migrateSnapshotToNewSchema(snapshot: any): SnapshotRecord {
  const now = Date.now();
...
export function createNewUserWithSchema(
  uid: string,
  name: string,
  email: string,
...
export function createNewSnapshotWithSchema(
  id: string,
  ownerUid: string,
  passwordHash: string,
  password: string,
