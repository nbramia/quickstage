...
export async function handlePurgeExpired(c: any) {
...
export async function handleGetUsers(c: any) {
...
export async function handleDeactivateUser(c: any) {
  const uid = await getUidFromSession(c);
  if (!uid) {
    // Track analytics event for unauthorized access attempt
    try {
...
export async function handleActivateUser(c: any) {
  const uid = await getUidFromSession(c);
  if (!uid) {
    // Track analytics event for unauthorized access attempt
    try {
...
export async function handleDeleteUser(c: any) {
  const uid = await getUidFromSession(c);
  if (!uid) {
    // Track analytics event for unauthorized access attempt
    try {
...
export async function handleSetupSuperadmin(c: any) {
...
export async function handleCleanupCorruptedUsers(c: any) {
  const uid = await getUidFromSession(c);
  if (!uid) {
    // Track analytics event for unauthorized access attempt
    try {
