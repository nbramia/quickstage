 ...
 */
export async function getUserByName(c, name) {
 ...
 */
export async function ensureUserByName(c, name) {
 ...
 */
export function getSubscriptionDisplayStatus(user) {
 ...
 */
export function canAccessProFeatures(user) {
 ...
 */
export function startFreeTrial(user) {
    const now = Date.now();
 ...
 */
export async function startTrialForUser(c, user) {
 ...
 */
export async function checkAndUpdateTrialStatus(c, user) {
    const subscriptionStatus = user.subscription?.status || user.subscriptionStatus || 'none';
    const trialEndsAt = user.subscription?.trialEnd || user.trialEndsAt;
