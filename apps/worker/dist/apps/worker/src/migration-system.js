...
export class MigrationSystem {
    ...
    migrateUserToNewSchema(user) {
        ...
        return { user: user, needsMigration, legacyFields, newFields };
    }
    /**
     * Migrate individual snapshot to new schema
     */
    migrateSnapshotToNewSchema(snapshot) {
        const now = Date.now();
        const legacyFields = [];
        const newFields = [];
        let needsMigration = false;
        ...
        return { snapshot: snapshot, needsMigration, legacyFields, newFields };
    }
    /**
