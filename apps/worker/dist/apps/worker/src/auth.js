 ...
 */
export async function getUidFromSession(c) {
 ...
 */
export async function getUidFromPAT(c, token) {
 ...
 */
export async function getUidByStripeCustomerId(c, customerId) {
 ...
 */
export async function isSuperadmin(c) {
