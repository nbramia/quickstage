...
import { handleCheckoutSessionCompleted, handleSubscriptionCreated, handleSubscriptionUpdated, handleSubscriptionDeleted, handlePaymentFailed, handlePaymentSucceeded } from '../stripe';
...
// Test user factory
const createTestUser = (uid, email, initialPlan = 'free') => ({
    uid,
    email,
    name: 'Test User',
    plan: initialPlan,
