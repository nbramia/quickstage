        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">10-Second Deploys</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">Secure by Default</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">Real-time Comments</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">Framework Agnostic</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              <div className="w-14 h-14 bg-gradient-to-br from-orange-500 to-purple-600 rounded-xl flex items-center justify-center mb-6 shadow-md">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">No Setup, No Config</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-700/50">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 font-inconsolata">Ship Ideas, Not PRDs</h3>
              <p className="text-gray-300 leading-relaxed font-poppins">
