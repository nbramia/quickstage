...
describe('SnapshotTable Component', () => {
    ...
    describe('Snapshot Display', () => {
        it('renders all snapshots by default', () => {
            render(_jsx(SnapshotTable, { snapshots: mockSnapshots, onRefresh: mockOnRefresh, selectedSnapshots: new Set(), onToggleSelect: mockOnToggleSelect, onSelectAll: mockOnSelectAll }));
    ...
    describe('Selection', () => {
        it('shows individual checkboxes for each snapshot', () => {
            render(_jsx(SnapshotTable, { snapshots: mockSnapshots, onRefresh: mockOnRefresh, selectedSnapshots: selectedSnapshots, onToggleSelect: mockOnToggleSelect, onSelectAll: mockOnSelectAll }));
    ...
    describe('Actions', () => {
        ...
        it('copies snapshot link to clipboard when copy button is clicked', async () => {
            ...
            if (copyButton) {
                ...
                await waitFor(() => {
                    expect(navigator.clipboard.writeText).toHaveBeenCalledWith('https://quickstage.tech/s/snap1\nPassword: test123');
                });
            }
        });
        ...
        it('has correct links to viewer for each snapshot', () => {
            render(_jsx(SnapshotTable, { snapshots: mockSnapshots, onRefresh: mockOnRefresh, selectedSnapshots: new Set(), onToggleSelect: mockOnToggleSelect, onSelectAll: mockOnSelectAll }));
            const viewLinks = screen.getAllByTitle('View').map(button => button.closest('a')?.getAttribute('href'));
    ...
    describe('Empty State', () => {
        it('shows empty state when no snapshots match filters', () => {
            render(_jsx(SnapshotTable, { snapshots: [], onRefresh: mockOnRefresh, selectedSnapshots: new Set(), onToggleSelect: mockOnToggleSelect, onSelectAll: mockOnSelectAll }));
