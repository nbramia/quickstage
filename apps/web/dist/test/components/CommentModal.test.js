...
describe('CommentModal Component', () => {
    ...
    describe('Basic Rendering', () => {
        ...
        it('shows element information when provided', () => {
            ...
            render(_jsx(CommentModal, { ...defaultProps, elementInfo: elementInfo }));
    ...
    describe('Form Submission', () => {
        it('submits comment with content only', async () => {
            ...
            render(_jsx(CommentModal, { ...defaultProps, onSuccess: onSuccess }));
            const textarea = screen.getByPlaceholderText('What would you like to comment about this element?');
            const submitButton = screen.getByText('Post Comment');
            fireEvent.change(textarea, { target: { value: 'Test comment content' } });
            fireEvent.click(submitButton);
            await waitFor(() => {
                expect(api.post).toHaveBeenCalledWith('/snapshots/test-snapshot/comments', expect.any(FormData), expect.objectContaining({
                    headers: {
    ...
    describe('Modal Behavior', () => {
        it('calls onClose when close button is clicked', () => {
            const onClose = vi.fn();
            render(_jsx(CommentModal, { ...defaultProps, onClose: onClose }));
        ...
        it('resets form after successful submission', async () => {
            ...
            expect(textarea.value).toBe(''); // This might not work due to component state
        });
    });
