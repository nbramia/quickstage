...
async function releaseWorkflow() {
  try {
    ...
    try {
      ...
      console.log('📦 Local VSIX contents:');
      ...
      console.log('✅ Local VSIX structure verified correctly\n');
    } catch (error) {
      console.error('❌ Local VSIX verification failed:', error.message);
    ...
    try {
      ...
      console.log('✅ VSIX structure verified correctly\n');
    } catch (error) {
      console.error('❌ VSIX structure verification failed:', error.message);
